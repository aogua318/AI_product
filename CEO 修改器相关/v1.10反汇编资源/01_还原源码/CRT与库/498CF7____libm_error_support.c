// 函数 0x498cf7  ___libm_error_support  size=0x297  模块=CRT与库
...
int (*__cdecl __libm_error_support(double *a1, double *a2, double *a3, int a4))()
{
  ...
  v14 = 0.0;
  if ( dword_8F3870 )
    result = (int (*)())DecodePointer(dword_8F61AC);
  else
    result = sub_49C4A6;
  if ( a4 > 166 )
  {
    switch ( a4 )
    {
      ...
      case 1009:
        goto LABEL_35;
      case 1010:
        v10 = (const char *)&unk_4AD638;
        goto LABEL_54;
      case 1011:
        v10 = (const char *)&unk_4AD634;
        goto LABEL_54;
      case 1012:
        v10 = (const char *)&unk_4AD630;
LABEL_54:
        v5 = a3;
        v8 = *a1 * v14;
        *a3 = v8;
