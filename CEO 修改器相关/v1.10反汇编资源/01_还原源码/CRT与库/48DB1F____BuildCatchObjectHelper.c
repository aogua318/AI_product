// 函数 0x48db1f  ___BuildCatchObjectHelper  size=0x17F  模块=CRT与库
  ...
  if ( v4 )
  {
    if ( *(_BYTE *)(v4 + 8) )
    {
      ...
      if ( v5 || *a3 < 0 )
      {
        ...
        if ( (*a3 & 8) != 0 )
        {
          if ( unknown_libname_4(*(_DWORD *)(a1 + 24)) && unknown_libname_4(v6) )
          {
            v7 = *(_DWORD *)(a1 + 24);
            *v6 = v7;
...
LABEL_11:
        ...
        else
        {
          ...
          if ( (*(_BYTE *)a4 & 1) != 0 )
          {
            if ( unknown_libname_4(v11) && unknown_libname_4(v6) )
            {
              memcpy_0(v6, *(const void **)(a1 + 24), *(_DWORD *)(a4 + 20));
          ...
          {
            if ( unknown_libname_4(v11) && unknown_libname_4(v6) && unknown_libname_4(*(_DWORD *)(a4 + 24)) )
              return ((*(_BYTE *)a4 & 4) != 0) + 1;
          }
          else if ( unknown_libname_4(v11) && unknown_libname_4(v6) )
          {
            v12 = *(_DWORD *)(a4 + 20);
