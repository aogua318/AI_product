// 函数 0x48e969  __pow_pentium4  size=0xB38  模块=CRT与库
        ...
        double a9)
{
  ...
  v9 = _mm_and_pd(a7, a1);
  a5.m128d_f64[0] = a8;
  inserted = _mm_srli_epi64((__m128i)a1, 0x2Cu);
  v13 = _mm_or_pd(v9, a3);
  epi16 = _mm_extract_epi16((__m128i)a5, 3);
  v12 = ((unsigned __int8)_mm_extract_epi16(inserted, 0) + 1) & 0x1FE;
  v13.m128d_f64[0] = v13.m128d_f64[0] * *(double *)((char *)&qword_4A63E0 + 4 * v12);
  a6.m128d_f64[0] = *(double *)((char *)&qword_4A63E0 + 4 * v12);
  v14 = *(__m128d *)((char *)&xmmword_4A67F0 + 8 * v12);
  v15 = 32751 - epi16;
  ...
  a4 = 0;
  v61 = _mm_max_epi16(_mm_sub_epi32(_mm_srli_epi64(v58, 0x14u), _mm_cvtsi32_si128(0x3F3u)), (__m128i)0LL);
  v62 = _mm_cmpeq_epi32(_mm_sll_epi64(v60, v61), (__m128i)0LL);
  v63 = _mm_movemask_epi8(v62);
  v64 = (32751 - v15) & 0x7FFF;
  if ( v64 >= 0x7FF0 )
  {
    a4.m128d_f64[0] = COERCE_DOUBLE(0xFFFFFFFFFFFFFLL);
    v72 = _mm_cmpeq_epi32((__m128i)0LL, (__m128i)_mm_and_pd(a4, a5));
    if ( (unsigned __int8)_mm_movemask_epi8(v72) == 255 )
    {
      if ( (_mm_extract_epi16((__m128i)a5, 3) & 0x8000) != 0 )
      {
        if ( v63 == 255 )
        {
          *(double *)v72.m128i_i64 = a9;
          *(double *)v62.m128i_i64 = a9;
          v72 = _mm_sub_epi32(
                  _mm_srli_epi64((__m128i)_mm_and_pd((__m128d)v72, (__m128d)xmmword_4A9C90), 0x34u),
                  _mm_cvtsi32_si128(0x3F4u));
          if ( (unsigned __int8)_mm_movemask_epi8(_mm_cmpeq_epi32(_mm_sll_epi64(v62, v72), (__m128i)0LL)) != 255 )
          {
            *(double *)v72.m128i_i64 = a9;
            if ( (_mm_extract_epi16(v72, 3) & 0x8000) == 0 )
              return -INFINITY;
            return -0.0;
          }
        }
...
X_NAN:
  ...
  *(double *)v61.m128i_i64 = a9;
  *(double *)v62.m128i_i64 = a9;
  a4 = (__m128d)_mm_cvtsi32_si128(0x3F4u);
  v65 = _mm_sub_epi32(_mm_srli_epi64((__m128i)_mm_and_pd((__m128d)v61, (__m128d)xmmword_4A9C90), 0x34u), (__m128i)a4);
  a4.m128d_f64[0] = -0.0;
...
DENORMAL_X:
  inserted = _mm_insert_epi16((__m128i)0LL, 0x43F0u, 3);
  v13.m128d_f64[0] = COERCE_DOUBLE(0xFFFFFFFFFFFFFLL);
  a3.m128d_f64[0] = 1.0;
  *(double *)inserted.m128i_i64 = *(double *)inserted.m128i_i64 * a8;
...
BACK_DEN:
  v68 = _mm_and_pd(v13, (__m128d)inserted);
  a5.m128d_f64[0] = *(double *)inserted.m128i_i64;
  inserted = _mm_srli_epi64((__m128i)_mm_and_pd((__m128d)inserted, (__m128d)xmmword_4A9C90), 0x2Cu);
  v13 = _mm_or_pd(v68, a3);
  v69 = ((unsigned __int8)_mm_extract_epi16(inserted, 0) + 1) & 0x1FE;
  v13.m128d_f64[0] = v13.m128d_f64[0] * *(double *)((char *)&qword_4A63E0 + 4 * v69);
  a6.m128d_f64[0] = *(double *)((char *)&qword_4A63E0 + 4 * v69);
  v14 = *(__m128d *)((char *)&xmmword_4A67F0 + 8 * v69);
  v17 = 278143;
BACK_MAIN:
  v18 = (__m128d)_mm_cvtsi32_si128(v17);
  v19 = _mm_cvtepi32_pd(_mm_srli_epi64(_mm_sub_epi64(inserted, (__m128i)v18), 8u));
  v18.m128d_f64[0] = NAN;
  ...
  a4.m128d_f64[0] = a4.m128d_f64[0] * *(double *)((char *)&qword_4A7000 + 4 * v21);
  a6.m128d_f64[0] = a6.m128d_f64[0] * *(double *)((char *)&qword_4A7000 + 4 * v21);
  v22 = _mm_add_pd(v14, *(__m128d *)((char *)&xmmword_4A7410 + 8 * v21));
  a5 = _mm_or_pd(_mm_and_pd(a5, (__m128d)xmmword_4A9C70), (__m128d)xmmword_4A9C80);
  ...
  a6.m128d_f64[0] = a6.m128d_f64[0] * *(double *)((char *)&qword_4A7C20 + 4 * v24);
  v25 = v23 * *(double *)((char *)&qword_4A7C20 + 4 * v24);
  v34 = _mm_add_pd(v22, *(__m128d *)((char *)&xmmword_4A8430 + 8 * v24));
...
RET_Y_NAN:
        ...
        (v101 | v100) < 0x80000000) )
  {
    ...
    *(_QWORD *)&v44 = _mm_shuffle_epi32((__m128i)v34, 238).m128i_u64[0];
    ...
    {
      v47 = _mm_mul_pd((__m128d)xmmword_4A9440, v35);
      v48 = _mm_mul_pd(v35, v35);
      v49 = (__m128i)_mm_add_pd(v47, _mm_mul_pd((__m128d)xmmword_4A9450, v48));
      *(double *)v49.m128i_i64 = *(double *)v49.m128i_i64 * v48.m128d_f64[0]
      ...
      v50 = (__m128i)_mm_mul_pd(
                       (__m128d)xmmword_4A9460[(int)v41 & 0x7F],
      ...
      v52 = _mm_mul_pd((__m128d)xmmword_4A9CA0, v51);
      v53 = 0.6931471805599453 * v51.m128d_f64[0];
      v54 = _mm_mul_pd(v51, v51);
      v55 = (__m128i)_mm_mul_pd(_mm_add_pd((__m128d)xmmword_4A9CB0, v52), v54);
...
RET_ZERO_UF:
    ...
    v84 = _mm_mul_pd((__m128d)xmmword_4A9440, v35);
    v85 = _mm_mul_pd(v35, v35);
    v33.m128d_f64[0] = v41 - (v41 + 6.755399441055744e15 - 6.755399441055744e15);
    v86 = (__m128i)_mm_add_pd(v84, _mm_mul_pd((__m128d)xmmword_4A9450, v85));
    v87 = (__m128i)_mm_mul_pd(
                     (__m128d)xmmword_4A9460[v79],
    ...
    v89 = _mm_mul_pd((__m128d)xmmword_4A9CA0, v88);
    v90 = 0.6931471805599453 * v88.m128d_f64[0];
    v70 = _mm_mul_pd(v88, v88);
    v91 = (__m128i)_mm_mul_pd(_mm_add_pd((__m128d)xmmword_4A9CB0, v89), v70);
