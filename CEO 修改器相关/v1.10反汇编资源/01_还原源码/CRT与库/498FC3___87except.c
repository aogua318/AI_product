// 函数 0x498fc3  __87except  size=0x13F  模块=CRT与库
...
void __usercall _87except(int a1@<ebp>, int a2, int a3, unsigned __int16 *a4)
{
  ...
  v17[0] = a1;
  v17[1] = retaddr;
  v16 = (unsigned int)v17 ^ dword_4B8254;
  v4 = *a4;
  v6 = *(_DWORD *)a3 - 1;
  v5 = *(_DWORD *)a3 == 1;
  v12 = v4;
...
LABEL_21:
  _ctrlfp(v12, 0xFFFF);
  if ( *(_DWORD *)a3 == 8 || dword_4B9630 || !sub_49C4A6(a3) )
    _set_errno_from_matherr(*(_DWORD *)a3);
  sub_488637((void *)((unsigned int)v17 ^ v16));
}
