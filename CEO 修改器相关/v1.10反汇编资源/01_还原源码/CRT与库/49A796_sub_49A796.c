// 函数 0x49a796  sub_49A796  size=0x551  模块=CRT与库
// 还原方式: Hex-Rays 反编译(伪 C 源码)

int __cdecl sub_49A796(unsigned __int16 *a1, unsigned int *a2)
{
  ...
  if ( v3 != -16383 )
  {
    ...
    v53 = v3;
    v59 = dword_4B92DC / 32;
    v9 = &v74 + dword_4B92DC / 32;
    v51 = 31 - dword_4B92DC % 32;
    if ( ((1 << v51) & *v9) != 0 )
    {
      v10 = dword_4B92DC / 32;
      for ( i = (~(-1 << (31 - dword_4B92DC % 32)) & *(&v74 + v59)) == 0; i; i = *(&v74 + v10) == 0 )
      {
        if ( ++v10 >= 3 )
          goto LABEL_21;
      }
...
LABEL_21:
    *v9 &= -1 << v51;
    ...
    if ( v65 )
      ++v3;
    if ( v3 >= dword_4B92D8 - dword_4B92DC )
    {
      if ( v3 > dword_4B92D8 )
      {
        if ( v3 < dword_4B92D4 )
      ...
      v74 = v71;
      v75 = v72;
      v17 = (dword_4B92D8 - v53) / 32;
      v76 = v73;
      v18 = (dword_4B92D8 - v53) % 32;
      v60 = 0;
      for ( m = 0; m < 3; ++m )
      {
        v19 = (int *)(&v74 + m);
      ...
      v23 = dword_4B92DC / 32;
      v52 = dword_4B92DC / 32;
      v24 = &v74 + dword_4B92DC / 32;
      v55 = 31 - dword_4B92DC % 32;
      if ( ((1 << v55) & *v24) != 0 )
      {
        for ( n = (~(-1 << (31 - dword_4B92DC % 32)) & *(&v74 + v23)) == 0; n; n = *(&v74 + v23) == 0 )
        {
          if ( ++v23 >= 3 )
            goto LABEL_51;
        }
...
LABEL_51:
      *v24 &= -1 << v55;
      ...
      v34 = (dword_4B92E0 + 1) / 32;
      v35 = (dword_4B92E0 + 1) % 32;
      v62 = 0;
      for ( jj = 0; jj < 3; ++jj )
      {
        v36 = (int *)(&v74 + jj);
  ...
  result = 2;
LABEL_78:
  v48 = v74 | (v50 != 0 ? 0x80000000 : 0) | (v5 << (31 - dword_4B92E0));
  if ( dword_4B92E4 == 64 )
  {
    v49 = v75;
    a2[1] = v48;
